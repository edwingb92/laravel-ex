...
<div class="col-xl-6 col-lg-12">
  ...
  <table id="mytable" class="table table-hover">
    ...
    <tbody>
      @if($tipospersona->count()) @foreach($tipospersona as $tipopersona)
      <tr>
        <td>{{$tipopersona->nombre}}</td>
        <td style="width: 40px">
          <a class="icon-pencil cyan font-large-1 float-xs-right" data-nombre="{{$tipopersona->nombre}}" data-id={{$tipopersona->id}} data-toggle="modal" data-target="#edit"></a>
        </td>
        <td style="width: 40px"><a class="icon-trash red font-large-1 float-xs-right" data-id={{$tipopersona->id}} data-toggle="modal" data-target="#delete"></a>
        </td>
      </tr>
